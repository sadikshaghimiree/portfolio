...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/sadikshaghimiree",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/sadikshaghimiree",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Medium",
    href: "https://medium.com/@sadikshaghimire29",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Email",
    href: "https://mail.google.com/mail/?view=cm&to=info.sadiksha@gmail.com",
    icon: (
